...
## Simply download `Colab-ESRGAN (old-arch).ipynb` and open it inside your Google Drive or click [here](https://colab.research.google.com/drive/1frIAOJmdbgZ08H2Bsb1nceqx5yxADgt3?usp=sharing) and copy the file with "File > Save a copy to Drive..." into your Google Drive. 
### 
...
- If you can't open `Colab-ESRGAN (old-arch).ipynb` inside your Google Drive, try this [colab link](https://colab.research.google.com/drive/1frIAOJmdbgZ08H2Bsb1nceqx5yxADgt3?usp=sharing) and save it to your Google Drive. The "open in Colab"-button can be missing in Google Drive, if that person never used Colab.
